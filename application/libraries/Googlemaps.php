...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyDep2wKaj3IJaFz3IoaV2uitMQDLbCWQVM'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $language					= 'th';						// The map will by default load in the language of the browser. This can be overriden however here. For a full list of codes see https://spreadsheets.google.com/pub?key=p9pdwsai2hDMsLkXsoM05KQ&gid=1
	...
	function create_map()
	{
		...
		// print_r($this->output_js_contents);
		...
		$data = array();
		if ($this->places) {
			$this->output_js_contents .= 'var Position
			function placesCallback(results, status) {
				if (status == google.maps.places.PlacesServiceStatus.OK) {
					for (var i = 0; i < results.length; i++) {
						...
						Position = {mark: place.name,lat : placeLoc.lat(),lng : placeLoc.lng()};
						results[i] = Position
					} 
					GetPosition(results)
					';
